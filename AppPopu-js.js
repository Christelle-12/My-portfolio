const seeBnt1 = document.querySelector('#openpop-1');
const popup1 = document.querySelector('.popup1');

const seeBnt2 = document.querySelector('#openpop-2');
const popup2 = document.querySelector('.popup2');

const seeBnt3 = document.querySelector('#openpop-3');
const popup3 = document.querySelector('.popup3');

const seeBnt4 = document.querySelector('#openpop-4');
